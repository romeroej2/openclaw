...
const allowedRawFetchCallsites = new Set([
  ...
  "extensions/google-gemini-cli-auth/oauth.ts:344",
  "extensions/google-gemini-cli-auth/oauth.ts:380",
  "extensions/google-gemini-cli-auth/oauth.ts:419",
  "extensions/google-gemini-cli-auth/oauth.ts:479",
  "extensions/google-gemini-cli-auth/oauth.ts:547",
  ...
  "extensions/mattermost/src/mattermost/monitor.ts:273",
